	...
	<form method="post" action="index.php">
        ...
        <?php
            if (isset($_POST["foo"]))
            {
                    try
                    {
                        $db = new PDO('mysql:host=localhost;dbname=cyril_db;charset=utf8','root','root');
